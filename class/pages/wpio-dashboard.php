...
add_thickbox();
?>
<div class="main-presentation" style="margin: 30px auto; max-width: 1200px; background-color:#f0f1f4;font-family: helvetica,arial,sans-serif;">
<div class="main-textcontent" style="margin: 0px auto; min-height: 300px; border-left: 1px dotted #d2d3d5; border-right: 1px dotted #d2d3d5; width: 840px; background-color:#fff;border-top: 5px solid #544766;" cellspacing="0" cellpadding="0" align="center">
   ...
   <p style="background-color: #ffffff; color: #445566; font-family: helvetica,arial,sans-serif; font-size: 14px; line-height: 22px; padding-left: 20px; padding-right: 20px; text-align: center;">
       ImageRecycle will help you to optimize automatically your website images &amp; PDF<br>In order to start the optimization process, you can create in one click a 15 days free trial account<br>to use our external hosted webservice.<br>This way, it will require less resources to your server.<br/>You can also use existing credentials. Enjoy!</p>
   <p></p>   
   <p><a style="width: 250px; float: left; background: #554766; font-size: 12px; line-height: 18px; text-align: center;  margin-left:20px;color: #fff;font-size: 14px;text-decoration: none; text-transform: uppercase; padding: 8px 20px; font-weight:bold;" href="<?php echo $urlToLoginAccount; ?>" class="thickbox">Use existing account</a></p>
   <p><a style="width: 250px; float: right; background: #554766; font-size: 12px; line-height: 18px; text-align: center;  margin-right:20px;color: #fff;font-size: 14px;text-decoration: none; text-transform: uppercase; padding: 8px 20px; font-weight:bold;" href="<?php echo $urlToCreateAccount; ?>" class="thickbox">Create a trial account</a></p>   
   <p style="background-color: #ffffff; color: #445566; font-family: helvetica,arial,sans-serif; font-size: 24px; line-height: 24px; padding-right: 10px; padding-left: 10px; padding-top: 40px;" align="center"><strong><br>Why ImageRecycle?<br></strong></p>
   <p style="background-color: #ffffff; color: #445566; font-family: helvetica,arial,sans-serif; font-size: 14px; line-height: 22px; padding-left: 20px; padding-right: 20px; text-align: center;">Images represent 60% to 70% of website page weight. Image optimization is good for your users and for your server.<br> You won't find any other service that compress in the same time .pdf .jpeg and .png images keeping the original quality. We are using a unique algorithm to achieve that. Each compression script is executed on an optimized server to serve you as fast as possible.</p>
